<script lang="ts" context="module">
	...
	const baseClasses = 'border p-2 font-stylized align-middle text-center';
	const primaryClasses =
		'border-primary-400 hover:border-primary-200 active:border-primary-500 bg-primary-500 hover:bg-primary-400 active:bg-primary-600 text-primary-fg';
	...
	const shadow4pxClasses = 'shadow-4px hover:shadow-8px active:shadow-2px';
	const shadow8pxClasses = 'shadow-8px hover:shadow-16px active:shadow-4px';
</script>
